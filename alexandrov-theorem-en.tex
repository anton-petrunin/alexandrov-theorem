...
Alexandrov's theorem states that the converse holds if one includes twice covered polygons.
In other words, a polyhedron can degenerate to a plane polygon;
...
The second part is called \emph{uniqueness theorem}.
