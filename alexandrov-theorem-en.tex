...
Note that the shortest line cannot pass through an essential vertex of $M$.
...
The proof of the invariance of domain theorem can be adapted to our case since both spaces $\Phi_n$ and $\Psi_n$ are $(3\cdot n-6)$-dimensional and both look like manifolds, although, formally speaking, they are \emph{not} manifolds.
