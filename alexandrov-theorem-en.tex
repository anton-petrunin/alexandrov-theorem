...
\hypersetup{
pdftitle={Alexandrov embedding theorem},
pdfauthor={Nina Levedeva and Anton Petrunin}
}
...
If $P$ has a nontrivial symmetry group, then this description is not one-to-one but it has an effect on the dimension of $\Phi_n$.
