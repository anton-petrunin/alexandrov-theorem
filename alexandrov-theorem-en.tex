...
A. D. Alexandrov has many remarkable theorems, but in our opinion this theorem is  most remarkable.
...
The latter statement is fundumntal in a branch of modern mathematics --- the so-called \emph{Alexandrov geometry}.

The first part is central; it is called the \emph{existence theorem}.
The second part is called \emph{uniqueness theorem}; it is a slight variation of Cauchy's theorem about polyheron.
(There is another uniqueness theorem of Alexandrov that generalizes Minkowski's theorem about  polyhedron.)
...
\parbf{Acknowledgments.} We want to thank S. Alexander, Y. Burago, and J. Tsukahara for help. The authors were partially supported by RFBR grant 20-01-00070 and NSF grant DMS-2005279.
